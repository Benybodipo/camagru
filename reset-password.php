      ...
      $crud->getAllWhere([
        ...
        $crud->update([
		  ...
		  $crud->delete([
			...
			$username = $crud::$result[0]["username"];
      $message = "Your new password is: ".$_POST['password']."  <a href='{$basic_url}/login.php?username={$username}'>Click here to login</a>";

			$email = $crud::$result[0]["email"];
			sendMail($email, "NEW PASSWORD", $message);
