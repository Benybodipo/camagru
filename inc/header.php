...
<body>
	<header class="shadow">
		...
		<?php endif; ?>
		<div class="container">
			<div class="logo"><a href="index.php">Camagru</a></div>
			<nav>
				<ul>
					<li>
						<a href="<?php echo (isset($_SESSION['loggedin'])) ? "edit" : "login"; ?>.php" class="btn fill rounded snap">snap a pic
					...
					<?php if (isset($_SESSION['loggedin']) && !empty($_SESSION['loggedin'])): ?>
						<li>
							...
							<ul class="drop-down shadow">
								<li><a href="gallery.php"><span class="icon icon-picture-o"></span> My snaps</a></li>
								<li><a href="profile.php"><span class="icon icon-widget"></span> Edit Profile</a></li>
