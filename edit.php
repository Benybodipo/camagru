...
<div class="camara-section clearfix">
	...
	<div class="option clearfix">
		<div class="btn" id="btnCamara"> <span class="icon icon-ios-videocam"></span><br>Camara</div>
		<div class="btn" id="btnCapture"> <span class="icon icon-camera-retro"></span><br>Capture</div>
		<div class="btn" id="btn-upload"> <span class="icon icon-laptop"></span ><br>Upload image</div>
